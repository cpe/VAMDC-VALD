...
from vamdctap.unitconv import eV2MHz, Angstr2MHz, invcm2MHz, bothStates
...
RETURNABLES = {
    ...
    'AtomSymbol': 'Atom.molecule.elementsymbol',
    ...
    'MoleculePartitionFunctionNSIName': 'Molecule.pfnsiname',
    'MoleculePartitionFunctionNSILowestEnergyStateRef':
        'Molecule.pflowestrovibstateid',
    'MoleculePartitionFunctionNSISymGroup': 'Molecule.pfsymmetrygroup',
    'MoleculePartitionFunctionNSILowestRoVibSym':
        'Molecule.pfnsilowestrovibsym',

    'MoleculeMolecularWeight': 'Molecule.massnumber',
    ...
    'MoleculeStateEnergyOrigin':
        'MoleculeState.origin()',  # 'Zero-point energy',
    'MoleculeStateEnergyUnit': '1/cm',
    'MoleculeStateEnergyMethod': 'MoleculeState.dataset_id',
    'MoleculeStateTotalStatisticalWeight': 'MoleculeState.degeneracy',
    'MoleculeStateNSIName': 'MoleculeState.nsiname()',
    'MoleculeStateNSILowestEnergyStateRef':
        'MoleculeState.nsi.lowestrovibstateid()',
    'MoleculeStateNSISymGroup': 'MoleculeState.nsi.symmetrygroup',
    'MoleculeStateNSILowestRoVibSym': 'MoleculeState.nsi.lowestrovibsym',
    'MoleculeStateNuclearStatisticalWeight':
        'MoleculeState.nuclearstatisticalweight',
    ...
    'MoleculeComment': 'Molecule.shortcomment',
    'MoleculeQnStateID': 'MolQN.stateid',
    'MoleculeQnCase': 'MolQN.case',
    'MoleculeQnLabel': 'MolQN.label',
    'MoleculeQnValue': 'MolQN.value',
    'MoleculeQnAttribute': 'MolQN.attribute',
    ...
    'RadTransProcess':
        'excitation',  # CDMS transitions are always absorption lines
...
def atomsymbol(r, op, *rhs):
    ...
    try:
        ...
        if op == 'in':
            ...
            return Q(**{'specie__molecule__stoichiometricformula'+'__in':
                        ins})\
                & Q(**{'specie__molecule__numberofatoms'+'': 'Atomic'})

        op = OPTRANS[op]
        ins = map(strip, rhs, ('\'"',)*len(rhs))
        return Q(**{'specie__molecule__stoichiometricformula'+op: ins[0]})\
            & Q(**{'specie__molecule__numberofatoms'+'': 'Atomic'})
...
def stoichiometricformula(r, op, rhs):
    ...
    try:
        op = OPTRANS[op]
        # float(rhs)
        return Q(**{'specie__molecule__stoichiometricformula'+op: rhs}) \
            & Q(**{'specie__molecule__numberofatoms'+'!=': 'Atomic'})
    except Exception:
        return Q(pk__isnull=True)
...
def environment(r, op, *rhs):
    """
    This is currently a dummy to pass the temperature as a variable to
    queryfunc.py
    """
...
RESTRICTABLES = {
    ...
    # 'AtomSymbol': '',
    'AtomSymbol': 'specie__atom__element',
    ...
    'MoleculeStateNSIName': 'lowerstateref__nsi__name',
